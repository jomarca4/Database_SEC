...
WHERE financial_statement_items.account_label LIKE '%even%' AND quarters."year"  =2020 AND financial_statements."type" = 'income_statement'
...
'''
    ...
    wb = xw.Book("income_stat_analysis.xlsx")
